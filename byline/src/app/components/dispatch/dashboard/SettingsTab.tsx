            ...
            <div style={{ display: "grid", gap: 12 }}>
              ...
              <div style={{ background: "var(--by-bg-3)", borderRadius: 6, border: "0.5px solid var(--by-border)", overflow: "hidden" }}>
                ...
                {APPROVAL_ROWS.map((row, index) => {
                  const mode = APPROVAL_OVERRIDES[row];
          ...
          <SectionShell title="Danger zone" eyebrow="Danger" danger>
            <div style={{ display: "grid", gap: 10 }}>
              <div style={{ display: "flex", justifyContent: "space-between", gap: 12, alignItems: "center" }}>
                ...
                <button style={{ padding: "7px 10px", borderRadius: 5, border: "0.5px solid var(--by-border)", background: "transparent", color: "var(--by-text)", fontFamily: "'JetBrains Mono', monospace", fontSize: 10, cursor: "pointer" }}>
                  export
                </button>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between", gap: 12, alignItems: "center" }}>
                ...
                <button style={{ padding: "7px 10px", borderRadius: 5, border: "0.5px solid color-mix(in srgb, var(--by-red) 55%, transparent)", background: "rgba(248,113,113,0.08)", color: "var(--by-red)", fontFamily: "'JetBrains Mono', monospace", fontSize: 10, cursor: "pointer" }}>
                  reset
                </button>
              </div>
            </div>
