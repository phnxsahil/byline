      ...
      <div className="mx-auto max-w-[1500px] px-4 py-4 sm:px-6">
        <header className="mb-4 flex flex-col gap-4 rounded-[28px] border border-ink/10 bg-paper-raised/70 px-5 py-4 backdrop-blur-sm lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Link
              to="/"
              className="rounded-full border border-ink/10 bg-white px-4 py-2 text-sm text-carbon transition-colors hover:text-ink"
            >
              Back to landing
            </Link>
            <button
              ...
              className="inline-flex items-center gap-2 rounded-full bg-ink px-4 py-2 text-sm font-medium text-paper transition-colors hover:bg-wire"
            >
            ...
            <div className="space-y-3">
              {dispatches.length === 0 ? (
                <button
                  type="button"
                  onClick={() => setShowComposer(true)}
                  className="flex w-full flex-col items-start gap-3 rounded-[22px] border border-dashed border-ink/15 bg-paper px-4 py-5 text-left transition-colors hover:border-wire/30"
                >
                    ...
                    {PLATFORM_ORDER.map((platform) => {
                      ...
                      return (
                        <button
                          ...
                          className={`inline-flex items-center gap-2 rounded-full border px-3 py-2 font-mono text-[11px] uppercase tracking-[0.24em] transition-colors ${
                  ...
                  <div>
                    ...
                    <div className="mt-4 flex flex-wrap items-center gap-3">
                      <button
                        ...
                        className="inline-flex items-center gap-2 rounded-full border border-ink/12 bg-white px-4 py-2 text-sm text-carbon transition-colors hover:text-ink disabled:opacity-50"
                      >
                      ...
                      <button
                        ...
                        disabled={!activeDraft || isSaving}
                        className="inline-flex items-center gap-2 rounded-full bg-ink px-4 py-2 text-sm font-medium text-paper transition-colors hover:bg-wire disabled:opacity-50"
                      >
              ...
              <div className="grid min-h-[520px] place-items-center rounded-[28px] border border-dashed border-ink/12 bg-paper">
                <div className="max-w-md text-center">
                  ...
                  <button
                    type="button"
                    onClick={() => setShowComposer(true)}
                    className="mt-6 inline-flex items-center gap-2 rounded-full bg-ink px-4 py-2 text-sm font-medium text-paper transition-colors hover:bg-wire"
                  >
                    <Plus className="size-4" />
                    New dispatch
                  </button>
          ...
          <div className="w-full max-w-2xl rounded-[30px] border border-ink/10 bg-paper p-5 shadow-[0_30px_100px_rgba(26,25,22,0.22)]">
            <div className="mb-5 flex items-start justify-between gap-3">
              ...
              <button
                ...
                className="rounded-full border border-ink/10 px-3 py-1.5 text-sm text-carbon transition-colors hover:text-ink"
              >
                Close
              </button>
            </div>
